...
@page { margin: 0; }
	...
	<body>
		...
		<header>
			<h1>Du Lịch An Toàn Thân Thiện</h1>
			<address >
		...
		<article>
			<h1>Recipient</h1>
			<address>
			<p>Tên Người Đặt : '.mb_strtoupper($customer->customer_name).'</td>
			
			<td>'.$customer->customer_email.'</td><br></p>
			</address>
			<table class="meta">
				<tr>
					<th><span>Tên khách đặt</span></th>
				...
				<tr>
					<th><span >Địa Chỉ Người Nhận</span></th>
			...
			<table class="inventory">
				...
				foreach($order_details_product as $key => $product){
					...
					<td><span>'.number_format($product->product_feeship,0,',','.').'đ'.'</span></td>
					<td><span>'.$product->product_save_quantity.'</span></td>
					<td><span>'.number_format($product->product_price,0,',','.').'đ'.'</span></td>
			...
			<table class="balance">
				...
				$output.='				
					<th><span >Phí Shíp</span></th>
					<td><span>'.number_format($product->product_feeship,0,',','.').'đ'.'</span></td>
				</tr>
				<tr>
					<th><span >Mã Khuyến Mãi</span></th>
					<td><span data-prefix></span><span >'.$coupon_echo.'</span></td>
				</tr>
				<tr>
					<th><span >Tổng Cộng</span></th>
					<td><span>'.number_format($total_coupon + $product->product_feeship,0,',','.').'đ'.'</span></td>
				</tr>
			</table>
			<br><br><br><br>
			<span>Người Lập Bảng: '.mb_strtoupper(session()->get('admin_name')).'</span>
		</article>
