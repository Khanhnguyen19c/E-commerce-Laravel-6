         ...
         foreach($gallery as $key => $gal){
             ...
             $output.='
                  ...
                  <tr>
                                     ...
                                     <img src="'.url('public/uploads/gallery/'.$gal->gallery_image).'" class="img-thumbnail" width="200" height="250">
                                     <div class="form-wrapper">
                                     <div class="upload-btn-wrapper">
                                     <input type="file" class="file_image" style="width:50%" data-gal_id="'.$gal->gallery_id.'" id="file-'.$gal->gallery_id.'" name="file" accept="image/*" />
                                     <span id="error_gallery"></span>
                                         <button class="btn_upload">Cập Nhật Ảnh</button>
                                     </div>
